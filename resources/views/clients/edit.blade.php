                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('clients.update', $client) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="credit_limit" id="credit_limit" value="{{ old('credit_limit', $client->credit_limit) }}" step="0.01" min="0"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        ...
                        <div class="flex justify-end space-x-3">
                            <a href="{{ route('clients.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Cancel</a>
                            <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Update Client</button>
                        </div>
                    </form>
                </div>
            </div>
